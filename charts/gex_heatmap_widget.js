...
(function () {
  ...
  table.ghtb tr td.ghk { background:none; color:#c3cad6; font-size:10.5px; text-align:right;
  ...
  function render(d) {
    ...
    <table class="ghtb"><tr><th class="ghk">Strike</th>`;
    ...
    h += `</table><div class="ghfoot">
      ...
      <span>UW greek-exposure · ×S²·0,01</span></div></div>`;
    b.innerHTML = h;
    const s = sub();
