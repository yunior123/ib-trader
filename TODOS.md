...
- [ ] 2026-07-28 (Yunior): "crea skills nuevos para capturar sentimiento. y monitorea korea" (~20:15) — en curso: skill `x-sentiment` + script `scripts/x_sentiment.py` (captura medida vía API de la cuenta) + Monitor de la sesión KRX de esta noche (Hynix post-earnings, Samsung, KOSPI)
