...
- [ ] 36. "add charm and tools for nice analysis like this [ballena MSFT: per-strike UW + ΔOI + gamma/charm por expiry]. make sure to create skills for it, save to memo" (2026-08-05 ~00:xx) — en curso: scripts/whale_forensics.py + skill + memoria
