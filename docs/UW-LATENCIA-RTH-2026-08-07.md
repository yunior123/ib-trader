# UW — latencia medida en sesion (2026-08-07)

Generado por `scripts/uw_latency_probe.py --rth-measure`. TODOS 8a (latencia) + 8b (websocket).

- Corrida: 2026-08-07T13:35:00.495971+00:00 UTC · en_rth=True · peticiones UW=9 (tope 10) · cupo 6134/30000
...
|---|---|---|---|
| `stock-state.tape_time` vs reloj (s) | -0.41 | 0.50 | 0.59 |
| `net-prem-ticks.tape_time` vs reloj (s) | 0.50 | 1.59 | 60.50 |
| UW − print finnhub (s, >0 = UW detras) | -3061.52 | -22.55 | -20.82 |

**Veredicto** (umbral de la casa: <60 s = candidato a tiempo real):
- `stock-state`: **CANDIDATO A TIEMPO-REAL**
- `net-prem-ticks`: **DELAYED — no dispara**
...
|---|---|---|---|---|---|
| sin enviar nada | HTTP/1.1 101 Switching Protocols | 0.1556 | 0.1558 | 0 | False |
| join lista | HTTP/1.1 101 Switching Protocols | 0.1386 | 0.1388 | 0 | False |
| join objeto | HTTP/1.1 101 Switching Protocols | 0.1499 | 0.1502 | 0 | False |
