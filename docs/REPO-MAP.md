...
- **scripts/x_post_common.py** — post/ledger compartido para todos los posters de X (OAuth1, cap duro 20/día $4/mes). Funcs: `load_budget()`, `posts_today_all()`, `make_auth()`, `upload_media()`, `gex_line()`, `post_text()` +4 más.
