# UW — latencia medida en sesion (2026-08-10)

Generado por `scripts/uw_latency_probe.py --rth-measure`. TODOS 8a (latencia) + 8b (websocket).

- Corrida: 2026-08-10T13:35:05.143242+00:00 UTC · en_rth=True · peticiones UW=0 (tope 10) · cupo None/None
...
|---|---|---|---|---|---|
| sin enviar nada | HTTP/1.1 401 Unauthorized | 0.1471 | 8.2103 | 320 | False |
| join lista | HTTP/1.1 401 Unauthorized | 0.1384 | 8.1605 | 320 | False |
| join objeto | HTTP/1.1 401 Unauthorized | 0.1726 | 8.1941 | 320 | False |
