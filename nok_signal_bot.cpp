...
//
// Data: scripts/nok_bar_bridge.py streams REAL Yahoo 1m completed bars as
...
int main(int argc, char** argv) {
    ...
    FILE* in = stdin;
    if (!use_stdin) {
        in = popen("venv/bin/python scripts/nok_bar_bridge.py 2>/dev/null", "r");
